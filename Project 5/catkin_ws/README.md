# Home Service Bot
Modified from https://github.com/dmarcr1997/UdacityHomeServiceBot/blob/main/README.md?plain=1

----
 To run this simulation go to src/scripts and run ./home_service.sh
 This command will spin up the following launch files
* turtlebot_world2.launch
    * Starts up the simulation world in gazebo and launches the turtlebot within the simulated environment
...
* amcl_demo.launch
    * Starts up the map server, amcl and the move_base nodes
    * amcl node
